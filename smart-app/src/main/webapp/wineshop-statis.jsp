        ...
        require(
                ...
                function(ec){
                    ...
                    $.ajax({
                        ...
                        url: "<%=request.getContextPath()%>/1.0/hotel/lastWeek",//要访问的后台地址
                        success: function(msg){//msg为返回的数据，在这里做数据绑定
                            if(msg.code==0){
                                option_cy.xAxis.push(msg.messages[0]);
                                option_cy.series.push(msg.messages[1]);
...
//                                data:[500, 1500, 1700, 1900, 2100]
                    ...
                    $.ajax({
                        type: "get",//使用get方法访问后台
                        dataType: "json",//返回json格式的数据
                        url: "<%=request.getContextPath()%>/1.0/hotel/nextWeek",//要访问的后台地址
                        success: function(msg){//msg为返回的数据，在这里做数据绑定
                            if(msg.code==0){
...
<script type="text/javascript">
    ...
    $.ajax({
        type: "get",//使用get方法访问后台
        dataType: "json",//返回json格式的数据
        url: "<%=request.getContextPath()%>/1.0/hotel/getMapData",//要访问的后台地址
        success: function(msg){//msg为返回的数据，在这里做数据绑定
