...
<body class="pad20">
	<div class="body_main">
			...
			<ul class="fields search pdt0 pdb0">
				<li class="pr9">
					<ul>
						...
						<li class="value">
							<input name="phoneNumber" type="text" class="w300 h27 inputStyle"/>
						</li>
					</ul>
				</li>
				<li class="pr9">
		...
		<div class="bt_icon bt_icon_b3 fr r240 pr bd0" onClick="addCompanyInfo()"><div class="text c1 pdl0">确定</div></div>
	</div>
	</body>
</html>
